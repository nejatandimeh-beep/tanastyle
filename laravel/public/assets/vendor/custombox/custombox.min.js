...
!function (a) {
    var b = "custombox", c = b + "-open", d = b + "-close", e = b + "-lock", f = "animateFrom",
        ...
        l = ["fall", "sidefall", "flip", "sign", "slit", "letmein", "makeway", "slip"], m = function () {
            function a() {
            ...
            function a(c) {
                ...
                if (d) this.element = d; else if (document.querySelector("." + b + "-container")) document.querySelector("." + b + "-container") && (this.element = document.querySelector("." + b + "-container")); else {
            ...
            return _createClass(a, [{
                ...
                key: "addSimpleClass", value: function () {
            ...
            return _createClass(a, [{
                key: "fetch", value: function () {
                    ...
                    return new Promise(function (b, c) {
                        ...
                        if (d && 11 == d[2].length) {
                            var e = document.createElement("div"), f = document.createElement("iframe");
                            if (f.setAttribute("src", "https://www.youtube.com/embed/" + d[2]), f.setAttribute("frameborder", "0"), f.setAttribute("allowfullscreen", ""), f.setAttribute("width", "100%"), f.setAttribute("height", "100%"), e.appendChild(f), !a.options.content.fullscreen) {
            ...
            return _createClass(f, [{
                ...
                key: "_close", value: function () {
                    var a = this, b = [this.content.bind(d).then(function () {
                ...
                key: "dispatchEvent", value: function (a) {
                    var c = a.replace(".on", ":").toLowerCase(), d = new CustomEvent(b + ":" + c),
                ...
                key: "close", value: function (a) {
                    var c = new CustomEvent(b + ":close"), d = document.querySelectorAll("." + b + "-content");
