        ...
        <div class="g-bg-black g-color-white text-center g-py-100">
            <div class="container">
                <header class="u-heading-v8-2 text-center g-width-70x--md mx-auto g-mb-80">
                    <h2 class="u-heading-v8__title text-uppercase g-font-weight-600 g-mb-25">درباره ما</h2>
        ...
        <ul class="row no-gutters list-inline g-mb-0">
            <li class="col list-inline-item g-mr-0">
                <a style="text-decoration: none"
                   class="d-block g-bg-primary-dark-v2 g-color-white-opacity-0_8 g-bg-instagram--hover g-color-white--hover g-font-size-16 text-center g-transition-0_2 g-pa-15"
                   href="https://www.instagram.com/mevan.ir/">
                    ...
                    <div class="shortcode-html">
                        ...
                        <div class="row no-gutters g-color-white text-center g-mb-80">
                            ...
                            <div class="col-md-6 col-lg-6 g-bg-primary-dark-v2 g-py-60">
                                ...
                                <strong class="d-block g-font-size-16 g-mt-10">قوانین و مقررات استفاده</strong>
                            </div>
                        </div>
                        <!-- End Contact Info -->
                    </div>
