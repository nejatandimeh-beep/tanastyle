            ...
            <div class="container">
                <header class="u-heading-v8-2 text-center g-width-70x--md mx-auto g-mb-80">
                    ...
                    <p class="lead g-mb-40 g-font-size-14">نیاز روز افزون جامعه به خدمات حرفه ای در دنیای مجازی ما را بر آن داشت تا در
                        ...
                        و همچنین با عرضه بهترین برندهای پوشاک از بازارچه های مرزی در تلاش است بستری مناسب برای شما عزیزان در زمینه مد و پوشاک فراهم آورد.<a href="{{route('aboutMe')}}" class="g-mr-5">بیشتر</a> </p>
...
{{--                </form>--}}
                ...
                <small class="d-block g-mt-15 g-font-size-default">تمامی حقوق این وب سایت برای شرکت تابش پس زمینه مکریان محفوظ است 1398</small>
            </div>
        </footer>
