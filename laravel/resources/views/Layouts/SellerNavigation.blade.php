                                                ...
                                                <ul class="list-unstyled h-100 g-py-10 g-pt-0">
                                                    ...
                                                    <li class="nav-item hs-has-sub-menu d-inline-block">
                                                        ...
                                                        <ul class="list-unstyled hs-sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('AddProduct_askSize',['36']) }}"
