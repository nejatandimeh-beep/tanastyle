...
<script>
    ...
    let encodeButton = document.getElementById('jpeg_encode_button');
    function previewFile() {
        let preview = document.getElementById('source_image');
        ...
        reader.addEventListener("load", function(e) {
            ...
            preview.onload = function() {
                ...
                let result_image = document.getElementById('result_compress_image');
                let quality = 95;
