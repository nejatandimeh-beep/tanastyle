...
//            $resNum = (string)$productInfo->ID . '-' . (string)$qty;
//            $MID = '12780197';
//            $redirectUrl = 'https://tanastyle.ir/Payment-Status';
...
//            );
//            return view('Customer.Payment', compact('result'));
    ...
    public function paymentStatus()
    {
        ...
        if (isset($_POST['State']) && $_POST['State'] == "OK") {
            ...
            if ($res <= 0) {
                ...
                $resNum = explode('-', $resNum);
                $new = $this->newOrder((int)$resNum[0], (int)$resNum[1], 0);
                return view('Customer.PaymentStatus', compact('refNum'));
            }
        } else {
            // Transaction Failed
