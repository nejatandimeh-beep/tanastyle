...
//      Set Data For Info Panel In Store Page
        ...
        $sumFPrice=(int)$info['sumFPrice'];
        if(Auth::guard('seller')->user()->NationalID!==2872282556){
            $sumFPrice = $sumFPrice-(($sumFPrice*5)/100);
        }
        $sumFPrice = (int)($sumFPrice-(($sumFPrice*9)/100));
        $sumFPrice = (string)$sumFPrice;
        $sumFPrice = substr($sumFPrice, 0, -3);
        $sumFPrice.='000';
