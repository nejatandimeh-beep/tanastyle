                                    ...
                                    <div dir="ltr" class="col-sm-9 force-col-12">
                                        <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                            <span style="cursor: default"
                                                  class="d-none align-self-center fa fa-check g-mr-5 g-bg-primary g-pa-15 g-color-white"
                                                  id="uploadingIcon11"></span>
                                            <input id="{{ 'fileShow11' }}"
...
<script>
    $(document).ready(function () {
        ...
        $('#imageUploadForm').on('submit', (function (e) {
            ...
            e.preventDefault();
            let formData = new FormData(this),bar = $('#progress'+inputID+' .bar'), percent = $('#progress'+inputID+' .percent');
            $.ajax({
                type: 'POST',
