            ...
            $('#crop').on('click', function () {
                ...
                canvas.toBlob(function (blob) {
                    ...
                    reader.onloadend = function () {
                        let imageTemp = new Image(), form=$('#imageUploadForm');
                        imageTemp.src =reader.result;
                        form.append(imageTemp);
                        form.children().last().attr('id','imageUrl'+inputID);
                        form.children().last().attr('name','imageUrl'+inputID);
                        $modal.modal('hide');
