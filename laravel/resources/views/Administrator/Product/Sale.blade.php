                            ...
                            <div class="table-responsive">
                                <table style="direction: rtl" class="table table-bordered u-table--v2">
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle text-center text-nowrap">مبلغ درگاه<span
                                                class="g-font-size-10 g-mr-3">(تومان)</span>
                                        </th>
...
{{--                                        <th class="align-middle text-center text-nowrap">گیرنده</th>--}}
                                    ...
                                    @foreach($saleTable as $key => $rec)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">{{ number_format($rec->OrderDetailFinalPrice) }}</td>
                                            <td class="align-middle text-center g-color-primary">{{ number_format($rec->OrderDetailFinalPrice * $rec->Qty) }}</td>
