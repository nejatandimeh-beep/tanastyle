                            ...
                            <form action="{{route('sellerNew')}}" method="POST" style="direction: rtl" id="registerForm"
                                ...
                                <div class="container g-py-30--lg g-px-60--lg">
                                    ...
                                    <div class="d-flex justify-content-end g-my-100">
                                        <button onclick="addSeller()" class="btn btn-l u-btn-outline-lightred u-btn-content g-font-weight-600 g-letter-spacing-0_5 text-uppercase g-brd-2 g-mr-10 g-mb-15">
                                        ...
                                        <button onclick="addSeller()" class="btn btn-l u-btn-outline-primary u-btn-content g-font-weight-600 g-letter-spacing-0_5 text-uppercase g-brd-2 g-mr-10 g-mb-15">
