...
@section('Content')
    ...
    <div class="g-bg-gray-dark-v2 g-color-white g-px-15 g-py-30">
        ...
        <ul class="nav nav-fill u-nav-v4-1 u-nav-light" role="tablist" data-target="nav-4-1-primary-hor-fill"
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--1" role="tab">پشتیبانی</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--2" role="tab">تحویل محصول</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--3" role="tab">مبالغ دریافتی</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--4" role="tab">فاکتورهای فروش</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--5" role="tab">انبار</a>
            </li>

            <!--اطلاعات مالی-->
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#nav-4-1-primary-hor-fill--6" role="tab">اطلاعات
                    مالی</a>
            </li>

            <!--اطلاعات کاربری-->
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#nav-4-1-primary-hor-fill--7" role="tab">اطلاعات
                    کاربری</a>
            </li>
        </ul>
        <!-- End Nav tabs -->
                                ...
                                <div class="container g-py-30--lg g-px-60--lg">
                                    ...
                                    <div class="form-group row g-mb-15">
                                        ...
                                        <div class="col-sm-9 force-col-12">
                                            <input id="user-name"
                                                   class="form-control form-control-md rounded-0 g-bg-gray-light-v3 g-font-size-16"
                                                   type="text"
                                                   value="{{$data->name}}"
                                                   name="name"
                                                   autofocus
                                        ...
                                        <div class="col-sm-9 force-col-12">
                                            <div class="d-flex">
                                                <select style="direction: ltr"
                                                        class="form-control form-control-md custom-select rounded-0 h-25 g-font-size-16 g-brd-left-none g-bg-gray-light-v3"
                                                        id="birthday-day"
                                                        name="day"
                                                        tabindex="3">
                                                    <option
                                                        value="{{substr($data->Birthday,8,2)}}">{{substr($data->Birthday,8,2)}}</option>
                                                ...
                                                <select style="direction: ltr"
                                                        ...
                                                        tabindex="4">
                                                    <option
                                                        value="{{substr($data->Birthday,5,2)}}">{{substr($data->Birthday,5,2)}}</option>
                                                    <option value="01">1</option>
                                                    <option value="02">2</option>
                                                    <option value="03">3</option>
                                                    <option value="04">4</option>
                                                ...
                                                <select style="direction: ltr"
                                                        id="birthday-year"
                                                        class="form-control form-control-md custom-select rounded-0 h-25 g-font-size-16 g-bg-gray-light-v3"
                                                        name="year"
                                                        tabindex="5">
                                                    <option
                                                        value="{{substr($data->Birthday,0,4)}}">{{substr($data->Birthday,0,4)}}</option>
                                            ...
                                            <div class="btn-group-lg d-flex">
                                                <label class="u-check col-md-6 g-pa-0">
                                                    ...
                                                    <span style="color: #555"
                                                          class="btn btn-md btn-block g-brd-white g-bg-gray-light-v3 g-brd-left-none g-brd-left-1--lg g-bg-primary--checked rounded-0 g-color-white--checked">زن</span>
                                                </label>
                                                <label class="u-check col-md-6 g-pa-0">
                                                    <input class="hidden-xs-up g-pos-abs g-top-0 g-left-0"
                                                           name="gender"
                                                           ...
                                                           value="1">
                                                    <span style="color: #555"
                                                          class="btn btn-md btn-block g-brd-white g-bg-gray-light-v3 g-bg-primary--checked rounded-0 g-color-white--checked">مرد</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row g-mb-15">
                                        ...
                                        <div class="col-sm-9 force-col-12 d-flex">
                                            <input
                                                style="direction: ltr"
                                                class="text-left col-8 form-control form-control-md rounded-0 g-bg-gray-light-v3 g-font-size-16"
                                                id="phoneNumber"
                                                name="phone"
                                                type="text"
                                                maxlength="8"
                                                value="{{substr($data->Phone,3,8)}}"
                                            ...
                                            <input
                                                ...
                                                id="phonePreNumber"
                                                name="prePhone"
                                                class="text-left col-4 form-control form-control-md rounded-0 g-bg-gray-light-v3 g-font-size-16 g-brd-right-none"
                                                maxlength="3"
                                                value="{{substr($data->Phone,0,3)}}"
                                    ...
                                    <div class="form-group row g-mb-15">
                                        ...
                                        <div class="col-sm-9 force-col-12">
                                            <input style="direction: ltr"
                                                   class="text-left form-control form-control-md rounded-0 g-bg-gray-light-v3 g-font-size-16"
                                                   id="mobile"
                                                   name="mobile"
                                                   maxlength="11"
                                                   value="{{$data->Mobile}}"
                                        ...
                                        <div class="col-sm-9 force-col-12">
                                            <div class="d-lg-flex">
                                                ...
                                                <select id="stateSelect"
                                                        ...
                                                        class="form-control form-control-md custom-select rounded-0 h-25 g-font-size-16 g-brd-left-none--lg g-bg-gray-light-v3 g-mb-10 g-mb-0--lg"
                                                        tabindex="3"
                                                        name="state"
                                    ...
                                    <div class="form-group row justify-content-center">
                                        ...
                                        <div dir="ltr" class="d-flex col-sm-9 force-col-12">
                                            <div class="col-md-4 p-0 g-mr-15">
                                                <a class="js-fancybox" href="{{asset($data->PicPath)}}"
                                                   ...
                                                   data-fancybox-bg="rgba(0,0,0, 1)">
                                                    <img class="img-fluid" src="{{asset($data->PicPath)}}"
                                                         alt="Image Description">
                                                </a>
                                            </div>
                                            <div class="col-md-4 p-0">
                                                <a class="js-fancybox" href="{{asset($data->PicPathCard)}}"
                                                   data-fancybox-animate-in="zoomIn" data-fancybox-animate-out="zoomOut"
                                                   data-fancybox-speed="200" data-fancybox-blur-bg="blur"
                                                   data-fancybox-bg="rgba(0,0,0, 1)">
                                                    <img class="img-fluid" src="{{asset($data->PicPathCard)}}"
                                                         alt="Image Description">
                                                </a>
                                            </div>
                                        </div>
