...
@section('Content')
    ...
    <div class="container p-lg-5 g-mt-50 gmb-10 modalBox">
        ...
        <!-- Hidden Input-->
            ...
            <input style="display: none" type="text" name="subCat" value="{{$subCat}}">
            ...
            <div class="form-group g-mb-20 text-right">
                ...
                <div class="input-group g-brd-primary--focus g-mb-10">
                    ...
                    <input style="direction: rtl"
                        ...
                        type="text"
                        id="productName"
                        oninput="$('#lblName').removeClass('g-color-red')"
                        tabindex="1"
                        value="{{$name}}"
            ...
            <div class="form-group g-mb-20 text-right smallDevices">
                ...
                <div style="direction: rtl">
                    ...
                    <small class="text-muted g-font-size-12">
                        کارمزد خدمات پلتفرم <small id="companyShare"></small></small>
            ...
            <div class="form-group g-mb-20 text-right bigDevices">
                ...
                <div style="direction: rtl">
                    ...
                    <small class="d-block text-muted g-font-size-12">سهم فروشنده <small
                            id="sellerShare"></small></small>
                    <small
                        class="text-muted g-font-size-12">کارمزد خدمات پلتفرم <small id="companyShare"></small></small>
{{--                    <small class="d-block text-muted g-font-size-12">9% ارزش افزوده <small id="exValue"></small></small>--}}
                </div>
            </div>
