    ...
    <div class="row justify-content-center">
        <div class="col-md-8 text-right">
            <div style="direction: rtl" class="card">
                <div class="card-header">بازیابی رمز ورود</div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input style="direction: ltr" id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ isset($email) ? $email : '' }}" required readonly>
