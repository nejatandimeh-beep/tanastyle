...
@section('content')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const VERIFY_URL = @json(route('verifyMobileSeller'));
            const RESEND_URL = @json(route('resendVerifyCodeSeller'));
            const CSRF = document.querySelector('meta[name="csrf-token"]').content;

            const TOTAL = 120;
            const STORAGE_KEY = 'seller_otp_timer';
                ...
                fetch(VERIFY_URL,{
                    ...
                    .then(d=>{
                        if(d.success){
                            ...
                            showToast(d.message || 'کد وارد شده اشتباه است');
