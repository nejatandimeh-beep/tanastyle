            ...
            <div class="col-md-7 col-lg-6">
                <div class="card shadow-lg border-0 rounded-3">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('sellerResetPassword') }}" novalidate>
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button style="border-radius: 0;" type="button"
                                            class="btn btn-outline-secondary g-brd-gray-light-v3 g-ml-5"
                                            id="togglePassword">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </div>
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary g-brd-gray-light-v3 g-ml-5"
    ...
    <script>
        ...
        passwordInput.addEventListener("input", function () {
            ...
            if (/[A-Z]/.test(val)) {
                ...
                rules.uppercase.classList.replace("text-success", "text-danger");
            }
            ...
            if (/[a-z]/.test(val)) {
                ...
                rules.lowercase.classList.replace("text-success", "text-danger");
            }
